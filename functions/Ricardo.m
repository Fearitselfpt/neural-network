function varargout = Ricardo(varargin)

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Ricardo_OpeningFcn, ...
                   'gui_OutputFcn',  @Ricardo_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Ricardo is made visible.
function Ricardo_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Ricardo (see VARARGIN)

% Choose default command line output for Ricardo
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Ricardo wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% Coloca a Fotografia
I=imread('ricardo.PNG','PNG');
...
function varargout = Ricardo_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
web('mailto:a21250197@alunos.isec.pt', '-browser')
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
uiwait(msgbox('Número de telemóvel: +351936687964','Skype','modal'));
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
web('https://moodle.isec.pt/moodle/user/profile.php?id=4890', '-browser')
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
web('https://www.facebook.com/fearitselfpt', '-browser')
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
web('https://www.instagram.com/fearitselfpt/', '-browser')
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
web('https://twitter.com/fearitselfpt', '-browser')
